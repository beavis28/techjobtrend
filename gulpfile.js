...
gulp.task('process', ['move_data'], shell.task([
  'cd dataProcess && python process_tag_data.py && python reconcile_tag_data.py && python make_pie_data.py && python region_data.py && python rss_parser.py && python amazon.py'
]));
